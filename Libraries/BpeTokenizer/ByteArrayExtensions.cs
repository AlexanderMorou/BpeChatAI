...
/// <summary>Extensions to <see cref="char"/>.</summary>
public static class CharExtensions
{
    ...
    static CharExtensions()
    {
        ...
        var assembly = typeof(CharExtensions).Assembly;
        try
        {
            using var stream =
                assembly.GetManifestResourceStream("BpeTokenizer.py_printable.blob.gz")
